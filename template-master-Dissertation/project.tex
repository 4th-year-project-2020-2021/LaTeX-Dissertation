...
%% Change these:
\newcommand{\projecttitle}{4th Year Applied Project and Minor Dissertation\\ Data Visualisation}
\newcommand{\projectauthor}{Grace Keane \\[0.2cm] Jina Kim \\[0.2cm] Shirin Nagle}
