...
\section{FireBase}
<<<<<<< HEAD
Firebase is a Backend-as-a-Service (Baas) and it is categorized as a NoSQL database program, which stores data in JSON-like documents.
...
\begin{center}    
      \includegraphics[scale=1]{img/FirebaseAuth.PNG}
\end{center}
...
After a successful sign in, we can access the user's basic profile information.
...
\begin{center}    
      \includegraphics[scale=0.8]{img/D3Ref.PNG}
\end{center}
=======
...
\section{D3}
>>>>>>> ab46c3a31e160e2f173e89abbb5e82566e8cba36
