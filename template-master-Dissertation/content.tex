...
\begin{center}    
      \includegraphics[scale=0.77]{img/Waterfall.png}
\end{center}

The waterfall model is still a widely used method for working on software projects in industry. It is arguably the most well known development model, which is likely attributed to how long the model has been around, not to mention the overall simplicity of the model. Each phase is of a waterfall project is completed sequentially \cite{balaji2012waterfall}. 
